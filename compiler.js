var fs, path, parse, EventEmitter, exec, spawn, Seq, setup, exports, compilers, DEFAULTS, LOG, CompilerMiddleware, register, Compiler, ExternalCompiler, CoffeeScriptCompiler, SnocketsCompiler, CocoCompiler, UglifyCompiler, MochiscriptCompiler, JadeCompiler, JadeBrowserPrecompiler, StylusCompiler, LessCompiler, SassCompiler, SassRubyCompiler, JisonCompiler, YamlCompiler, helpers, expand, extrema, commonPrefix, commonPath, mkdirp, _ref, __slice = [].slice;
fs = require('fs');
path = require('path');
...
exports.MochiscriptCompiler = MochiscriptCompiler = (function(superclass){
  MochiscriptCompiler.displayName = 'MochiscriptCompiler';
  var prototype = __extend(MochiscriptCompiler, superclass).prototype, constructor = MochiscriptCompiler;
  prototype.id = 'mochiscript';
  prototype.ext = '.ms';
  prototype.destExt = '.js';
  prototype.module = 'mochiscript';
  prototype.options = {
    bare: true
  };
  prototype.compileSync = 'compile';
  function MochiscriptCompiler(){
    superclass.apply(this, arguments);
  }
  return MochiscriptCompiler;
}(Compiler));
...
[CoffeeScriptCompiler, SnocketsCompiler, CocoCompiler, UglifyCompiler, JadeCompiler, JadeBrowserPrecompiler, StylusCompiler, LessCompiler, SassCompiler, JisonCompiler, SassRubyCompiler, YamlCompiler, MochiscriptCompiler].map(register);
